...
const Contact = () => {
    ...
    return (
        <section className='bg-warning text-white font-bold'>
            <hr />
            <div className='px-4'>
                <div className='grid md:grid-cols-2 gap-7 bg-slate-900 rounded-xl p-4 my-20'>
                    <div>
                        <div className="flex flex-col w-full border-opacity-50">
                            <div className="divider text-3xl">Contact us</div>
                        </div>
                        <div>
                            <h2 className='text-xl'><span className='text-5xl text-warning'>|</span> 24/7 At your service</h2>
                            <h2 className='text-xl mt-7'>SHOP LOCATION</h2>
                            <p className='text-xs tracking-wider'>1000 Dhaka, Savar New-Market Street, Bangladesh 23221
                                Latitude: 804.355.4383 Longitude: 804.367.7901</p>
                            <h2 className='text-xl mt-4'>STORE HOURS</h2>
                            <p className='text-xs tracking-wider'>Monday-Saturday 11am-7pm ET
                                Sunday 11am-6pm ET</p>
                            <h2 className='text-xl mt-4'>SPECIALIST HOURS</h2>
                            <p className='text-xs tracking-wider'>Monday-Friday 9am-5pm ET</p>
                        </div>
                        <Social />
                    </div>
