        ...
        <div className='py-20 mx-5'>
            ...
            <div className='grid grid-cols-2 md:grid-cols-4 gap-5 text-center mt-10 lg:max-w-4xl mx-auto'>
                <div className='bg-black w-44 rounded text-white'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="lg:h-20 lg:w-20 bg-warning rounded" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div className='bg-black w-44 rounded text-white'>
                    <svg xmlns="http://www.w3.org/2000/svg" className="lg:h-20 lg:w-20 bg-warning rounded" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
