...
const Footer = () => {
    return (
        <div className='w-full'>
            ...
            <hr />
            <p className='md:text-xl text-center py-2 bg-black text-white'>Copyright © 2022 - All right reserved by <span className='text-xl text-warning'>POWER TOOLS</span></p>
        </div>
    );
};
